...
https://git-scm.com/learn - *Git - Learn*

### 官方教程

1. https://git-scm.com/docs - *Git - Reference* [GitHub Repo](https://github.com/git/git-scm.com)

    ![GitHub last commit](https://img.shields.io/github/last-commit/git/git-scm.com?logo=github&color=blue)
    ![GitHub Repo stars](https://img.shields.io/github/stars/git/git-scm.com?style=social)
2. https://git-scm.com/book/zh/ - *Git - Book*

#### Manual Pages

[The Git User’s Manual](https://git-scm.com/docs/user-manual)
1. [git[1]](https://git-scm.com/docs/git)
2. [gitrevisions[7]](https://git-scm.com/docs/gitrevisions/zh_HANS-CN)
3. [gittutorial[7]](https://git-scm.com/docs/gittutorial/zh_HANS-CN)
...
1. https://git-scm.com/cheat-sheet - *Git Cheat Sheet*
2. https://ndpsoftware.com/git-cheatsheet.html - *index :: Git Cheatsheet :: NDP Software* [GitHub Repo](https://github.com/ndp/git-cheatsheet)
...
https://git-scm.com/tools/command-line - *Git - Command Line Tools*

1. [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) - *Good-lookin&#39; diffs. Actually… nah… The best-lookin&#39; diffs. :tada: - so-fancy/diff-so-fancy*

    - 支持 macOS, Linux, Android（Termux）

    - 开源免费（[GitHub Repo](https://github.com/so-fancy/diff-so-fancy)）

2. [GitUI by extrawurst](https://extrawurst.itch.io/gitui) - *blazing fast terminal-ui for git written in rust*
...
https://git-scm.com/tools/hosting - *Git - Hosting*

1. [Bitbucket](https://www.atlassian.com/zh/software/bitbucket) - *用于团队的 Atlassian Bitbucket Git 代码管理工具 | Atlassian*
2. [Codeberg.org](https://codeberg.org/) - *Codeberg is a non-profit, community-led organization that aims to help free and open source projects prosper by giving them a safe and friendly home.*
3. [GitCode](https://gitcode.net/) - *GitCode——开源代码托管平台，独立第三方开源社区，Git/Github/Gitlab*
4. [Gitee](https://gitee.com/) - *Gitee - 基于 Git 的代码托管和研发协作平台*
5. [GitHub](https://github.com/) - *GitHub: Where the world builds software · GitHub* [使用手册](os/tools/developer/vcs/github.md)
6. [GitLab](https://gitlab.com/gitlab-com) - *The One DevOps Platform | GitLab*
7. [阿里云云效 Codeup](https://codeup.aliyun.com/) - *云效 Codeup · 企业级代码管理平台* [旧版](https://code.aliyun.com/)
8. [腾讯云 CODING DevOps](https://coding.net/) - *DevOps_DevOps 解决方案_一站式 DevOps_开发者工具 | 腾讯云 CODING DevOps*
...
4. 编辑 git 配置文件
    ...
    注：部分设备（例如：**Termux** ）未执行此命令，会提示错误：“必须执行此命令”（在提示的内容中复制命令执行即可）。
...
1. 从远程仓库获取代码，合并到本地仓库的主分支

    ```bash
    git pull
    ```

2. 查看仓库当前的状态，显示有变更的文件
...
> [git-version](https://git-scm.com/docs/git-version) - Display version information about Git
...
> [git-add 添加](https://git-scm.com/docs/git-add/zh_HANS-CN) - 添加内容到索引
...
> [git-checkout 解决合并冲突](https://git-scm.com/docs/git-checkout/zh_HANS-CN) - 切换分支或恢复工作目录树文件
...
> [git-clone 克隆](https://git-scm.com/docs/git-clone/zh_HANS-CN) - 将存储库克隆到新目录
...
> [git-config 配置](https://git-scm.com/docs/git-config/zh_HANS-CN) - 获取和设置仓库或全局选项
...
> [git-commit 提交](https://git-scm.com/docs/git-commit/zh_HANS-CN) - 记录仓库的修改
...
```bash
git commit --reset-author -C HEAD
```
...
> [git-diff 文件差异](https://git-scm.com/docs/git-diff/zh_HANS-CN) - 显示提交和工作区等变化
...
显示两次提交之间的差异（first-branch 相当于 commit）：
...
> [git-log 查看提交历史](https://git-scm.com/docs/git-log/zh_HANS-CN) - 显示提交日志
...
> [git-merge](https://git-scm.com/docs/git-merge/zh_HANS-CN) - 将两个或多个开发历史合并在一起
...
> [git-mv 移动与重命名](https://git-scm.com/docs/git-mv/zh_HANS-CN) - 移动或重命名一个文件、一个目录或一个符号链接
...
> [git-push 推送改动](https://git-scm.com/docs/git-push/zh_HANS-CN) - 与相关对象一起更新远程分支引用
...
> [git-remote 远程](https://git-scm.com/docs/git-remote/zh_HANS-CN) - 管理一组追踪的仓库
...
示例：`git remote add origin git@github.com:vc-awesome/docs-learning.git`
...
示例：`git remote set-url origin http://137.220.33.223:6099/p/bitex.git`
...
> [git-reset 重置](https://git-scm.com/docs/git-reset/zh_HANS-CN) - 重置当前HEAD到指定的状态
...
> [git-restore 恢复](https://git-scm.com/docs/git-restore/zh_HANS-CN) - 恢复工作树文件
...
> [git-revert](https://git-scm.com/docs/git-revert/zh_HANS-CN) - 还原某些现有提交
...
> [git-show 显示](https://git-scm.com/docs/git-show/zh_HANS-CN) - 显示各种类型的对象
...
> [git-status 状态](https://git-scm.com/docs/git-status/zh_HANS-CN) - 显示工作树状态
...
> [git-switch](https://git-scm.com/docs/git-switch/zh_HANS-CN) - 切换分支
...
> [git-cherry-pick](https://git-scm.com/docs/git-cherry-pick/zh_HANS-CN) - 应用某些现有提交引入的更改
...
> [git-ls-files 列出文件信息](https://git-scm.com/docs/git-ls-files/zh_HANS-CN) - *显示索引和工作目录树中的文件信息*
...
> [git-ls-tree 列出树对象](https://git-scm.com/docs/git-ls-tree/zh_HANS-CN) - 列出树对象的内容
...
> [git-rebase 变基](https://git-scm.com/docs/git-rebase/zh_HANS-CN) - 在另一个基础提示之上重新应用提交内容
...
1. <https://git-scm.com/book/zh/v2/Git-分支-变基> - *Git - 变基*
2. https://www.liaoxuefeng.com/wiki/896043488029600/1216289527823648 - *Rebase - 廖雪峰的官方网站*
3. https://waynerv.com/posts/git-rebase-intro/ - *git rebase 用法详解与工作原理 | Shall We Code?*
4. https://blog.csdn.net/weixin_42310154/article/details/119004977 - *git rebase详解（图解+最简单示例，一次就懂）-CSDN博客*
5. https://zhuanlan.zhihu.com/p/271677627 - *详解git rebase，让你走上git大神之路 - 知乎*

#### reflog

> [git-reflog 重引用日志](https://git-scm.com/docs/git-reflog/zh_HANS-CN) - 管理重引用日志信息
...
![GitHub Release Date - Published_At](https://img.shields.io/github/release-date/carloscuesta/gitmoji?display_date=published_at&logo=github)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/carloscuesta/gitmoji?logo=github)
...
1. https://github.com/carloscuesta/gitmoji-cli - *GitHub - carloscuesta/gitmoji-cli: A gitmoji interactive command line tool for using emojis on commits. 💻*
...
<https://git-scm.com/docs/git/zh_HANS-CN#_重置恢复和还原> - *Git - git Documentation*
...
3. 场景三：已使用 `git commit` 提交了代码
   ...
   - 回退到指定版本 `git reset --hard <commit>`（使用 `git log` 命令查看 git 提交历史和 commit id）
...
https://git-scm.com/docs/gitglossary/zh_HANS-CN - *Git - gitglossary Documentation*

#### commit

> 提交

https://git-scm.com/docs/gitglossary#def_commit - *Git - gitglossary Documentation*
...
https://git-scm.com/docs/gitglossary#def_object - *Git - gitglossary Documentation*
...
https://git-scm.com/docs/gitglossary#def_pathspec - *Git - gitglossary Documentation*
...
https://git-scm.com/docs/gitglossary#def_tree - *Git - gitglossary Documentation*
