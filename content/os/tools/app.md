...
1. ✅ [Git](https://git-scm.com/) <i id="git"></i> - *Git is a free and open source distributed version control system designed to handle everything from small to very large projects with speed and efficiency.* [使用手册](os/tools/developer/vcs/git.md)
...
3. ✅ [质感文件（Material Files）]() - *开源的 Material Design 文件管理器*
...
- 安装教程
    ...
    1. https://www.bilibili.com/video/BV17U4y1s7v9 - *M1芯片Mac 虚拟机安装 ARM Windows教程，Parallels 体验一流_哔哩哔哩_bilibili*
...
3. [Joplin](https://joplinapp.org/) - *Joplin是一个开源的记事本应用程序。捕捉你的想法并从任何设备上安全地访问它们。*
    ...
    - 开源软件（[GitHub Repo](https://github.com/laurent22/joplin/)）
...
1. ✅ [Alfred](https://www.alfredapp.com/) - *Alfred is a productivity application for macOS, which boosts your efficiency with hotkeys, keywords and text expansion. Search your Mac and the web, and control your Mac using custom actions with the Powerpack.* [使用手册](os/desktop/mac/app/alfred.md)
...
1. [7-Zip](https://www.7-zip.org/) <i id="seven-zip"></i> - *7-Zip 是一款拥有极高压缩比的开源压缩软件。*
    ...
    - 开源软件（[GitHub Repo](https://github.com/ip7z/7zip)）
...
1. [Win10注册表修复工具](https://iknow.lenovo.com.cn/detail/kd_26709.html) - *Lenovo Quick Fix：Win10注册表修复工具-联想知识库*
...
7. ✅ [PowerToys](#) <i id="power-toys"></i> - *Windows system utilities to maximize productivity* [docs](https://docs.microsoft.com/zh-cn/windows/powertoys/)

    - 开源软件（[GitHub Repo](https://github.com/microsoft/PowerToys)）
...
9. 开始菜单增强工具
    ...
    1. [Open-Shell](https://open-shell.github.io/Open-Shell-Menu) - *Classic Shell Reborn.*

        - 开源软件（[GitHub Repo](https://github.com/Open-Shell/Open-Shell-Menu)）
...
12. 显示器增强工具
    ...
    1. [WinDynamicDesktop](https://windd.info) - *GitHub - t1m0thyj/WinDynamicDesktop: Port of macOS Mojave Dynamic Desktop feature to Windows 10* [WinDynamicDesktop：让 Windows 10 拥有随时间变化的动态壁纸 - 少数派](https://sspai.com/post/59458)

        - 开源软件（[GitHub Repo](https://github.com/t1m0thyj/WinDynamicDesktop)）
...
3. ✅ [Delta Chat，去中心化的安全聊天软件 - Delta Chat](https://delta.chat/) - *Delta Chat，去中心化的安全聊天软件 💬 稳定可靠的即时通讯，支持多账户和多设备 ⚡️ Sign up to secure and interoperable chatmail relays 🥳 在聊天中体验互动网页应用，一起游戏和协作 🔒 经过审计的端到端加密，安全可靠，防御网络和服务器攻击 👉 自由开源软件，基于互联网标准构建，告别 xkcd927 困境 :) 下载 可在手机和桌...*

    - 支持 Windows（[Microsoft Store](https://apps.microsoft.com/detail/9pjtxx7hn3pk)）, macOS（[App Store](https://apps.apple.com/us/app/delta-chat-desktop/id1462750497)）, Linux, Android（[GitHub Releases](https://github.com/deltachat/deltachat-android/releases), [Google Play](https://play.google.com/store/apps/details?id=chat.delta), [F-Droid](https://f-droid.org/app/com.b44t.messenger)）, iOS（[App Store](https://apps.apple.com/us/app/delta-chat/id1459523234)）

    - 开源软件（[GitHub Org](https://github.com/deltachat/)）

4. [Manyverse – a peer-to-peer social network](https://www.manyver.se/) - *A social network off the grid – mobile and available on Android*
...
1. ✅ [scrcpy](https://github.com/Genymobile/scrcpy/wiki/README.zh-Hans) - *Display and control your Android device. Contribute to Genymobile/scrcpy development by creating an account on GitHub.*
    ...
    - 开源软件（[GitHub Repo](https://github.com/Genymobile/scrcpy)）
