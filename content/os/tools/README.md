...
<i class="ri-open-source-fill medium-green"></i> 表示 开源（免费）软件  
<i class="fa fa-shopping-cart"></i> 表示 付费  
<i class="fa fa-user-circle-o"></i> 表示 支持注册登录  

<i class="fa-brands fa-windows fa-fw"></i> 表示 支持 _Windows_  
<i class="fa-brands fa-linux fa-fw"></i> 表示 支持 _Linux_  
<i class="fa-brands fa-apple fa-fw"></i> 表示 支持 _macOS_  
...
<i class="fa-brands fa-chrome fa-fw"></i> 表示 支持 浏览器扩展  
...
<i class="fa-brands fa-github"></i> 表示 支持 _GitHub_ 下载  
...
2. https://1password.com/zh-cn - *1Password - 适用于家庭、企业、团队的密码管理器 | 1Password*
...
3. https://www.yxssp.com/26940.html - *NetGuard Pro v2.305 for Android 直装已付费专业版—— 一款简洁实用的网络权限管理应用 | 异星软件空间*
