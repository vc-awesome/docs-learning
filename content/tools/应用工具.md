...
2. [GitHub Desktop](tools/git#github-desktop) + [Sourcetree](/tools/git.md#sourcetree) +  [Typora](#markdown-typora) + [Sublime](#sublime)
...
2. [Sourcetree](/tools/git.md#sourcetree) + [GitHub](/tools/github.md) + [Typora](#markdown-typora) + [Sublime](#sublime)
...
3. [MGit](os/mobile/mgit.md) + [Markor](#markor) + [Termux](/os/mobile/app-termux)
