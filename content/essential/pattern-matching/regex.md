...
1. https://wangchujiang.com/reference/docs/regex.html - *RegEX 备忘清单 & regex cheatsheet & Quick Reference*

### 维基百科

1. <https://zh.wikipedia.org/zh-cn/正则表达式> - *正则表达式 - 维基百科，自由的百科全书*
...
https://cloud.tencent.com/developer/article/2475927 - *【编程语言】正则表达式：POSIX 与 PCRE 的全面比较及应用-腾讯云开发者社区-腾讯云*
...
[代码片段 - javascript 字符串替换](snippets/javascript/README.md#字符串替换)
