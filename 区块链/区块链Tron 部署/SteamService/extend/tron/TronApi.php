...
class TronApi
{
    ...
    function getContractEvents($contractAddress, $since, $min_block_timestamp)
    {
        $api = '/v1/contracts/' . $contractAddress . '/events';
        $payload = ['event_name' => $since, 'only_confirmed' => 'true', 'order_by' => 'block_timestamp,asc', 'limit' => '200', 'min_block_timestamp' => $min_block_timestamp];
