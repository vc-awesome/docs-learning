...
<span class="icon octicon-file npm-icon medium-red "></span> jsdeliver https://www.jsdelivr.com/package/npm/file-icons-js

<span class="icon octicon-file css3-icon medium-blue "></span> jsdeliver https://cdn.jsdelivr.net/npm/file-icons-js@1.1.0/css/style.css

`From` <i class="fa fa-github fa-lg"></i> https://github.com/homerchen19/github-file-icons *谷歌扩展程序*
