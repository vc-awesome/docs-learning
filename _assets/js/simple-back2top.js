...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    styleInject(" #right-bottom-float-btns{position:fixed !important;display:-webkit-box !important;display:-ms-flexbox !important;display:flex !important;-webkit-box-orient:vertical !important;-webkit-box-direction:normal !important;-ms-flex-direction:column !important;flex-direction:column !important;right:10px !important;bottom:10px !important;z-index:1}#right-bottom-float-btns button{font:inherit;margin:0;overflow:visible;text-transform:none;font-family:inherit;position:relative;display:inline-block;padding:5px 16px;font-size:14px;font-weight:500;line-height:20px;white-space:nowrap;vertical-align:middle;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:1px solid;border-radius:6px;-webkit-appearance:none;-moz-appearance:none;appearance:none;color:#24292f;background-color:#f6f8fa;border-color:rgba(27,31,36,.15);-webkit-box-shadow:0 1px 0 rgba(27,31,36,.04),inset 0 1px 0 rgba(255,255,255,.25);box-shadow:0 1px 0 rgba(27,31,36,.04),inset 0 1px 0 rgba(255,255,255,.25);-webkit-transition:80ms cubic-bezier(.33,1,.68,1);-o-transition:80ms cubic-bezier(.33,1,.68,1);transition:80ms cubic-bezier(.33,1,.68,1);-webkit-transition-property:color,background-color,border-color,-webkit-box-shadow;transition-property:color,background-color,border-color,-webkit-box-shadow;-o-transition-property:color,background-color,box-shadow,border-color;transition-property:color,background-color,box-shadow,border-color;transition-property:color,background-color,box-shadow,border-color,-webkit-box-shadow;color:var(--theme-color,#0969da);padding:0 12px;font-size:12px;line-height:20px;margin-top:6px;opacity:.6}#right-bottom-float-btns button:hover{-webkit-transition-duration:.1s;-o-transition-duration:.1s;transition-duration:.1s;text-decoration:none;color:#ffffff;background-color:var(--theme-color,#0969da);border-color:rgba(27,31,36,0.15);-webkit-box-shadow:rgba(27,31,36,0.04) 0px 1px 0px 0px,rgba(255,255,255,0.25) 0px 1px 0px 0px inset;box-shadow:rgba(27,31,36,0.04) 0px 1px 0px 0px,rgba(255,255,255,0.25) 0px 1px 0px 0px inset}#right-bottom-float-btns button:active{-webkit-transition:none;-o-transition:none;transition:none;color:#ffffff;/*background-color:hsla(212,92%,42%,1);*/background-color:var(--theme-color,hsla(212,92%,42%,1));border-color:rgba(27,31,36,0.15);-webkit-box-shadow:rgba(27,31,36,0.15);box-shadow:rgba(27,31,36,0.15)}#right-bottom-float-btns button:focus{outline:2px solid var(--theme-color,#0969da);outline-offset:-2px;-webkit-box-shadow:none;box-shadow:none}#right-bottom-float-btns button:focus:not(:focus-visible){outline:solid 1px transparent}#right-bottom-float-btns button:focus-visible{outline:2px solid var(--theme-color,#0969da);outline-offset:-2px;-webkit-box-shadow:none;box-shadow:none}#right-bottom-float-btns button.back-to-top-progress{display:inline-block;padding:0;font-size:inherit;color:var(--theme-color,#0969da);text-decoration:none;white-space:nowrap;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-color:transparent;border:0;-webkit-appearance:none;-moz-appearance:none;appearance:none}");
