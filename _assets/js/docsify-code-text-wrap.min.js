...
! function () {
    ...
    ! function (o, e) {
        ...
        ".docsify-code-text-wrap-button,.docsify-code-text-wrap-button span{cursor:pointer;transition:all .25s ease}.docsify-code-text-wrap-button{position:absolute;z-index:1;top:0;right:38px;overflow:visible;padding:5px;border:0;border-radius:0;outline:0;font-size:1em;background:#808080;color:#fff;opacity:0}.docsify-code-text-wrap-button span{border:0;border-radius:3px;background:inherit;pointer-events:none}.docsify-code-text-wrap-button:focus,pre:hover .docsify-code-text-wrap-button{opacity:1}.docsify-code-text-wrap-on{color:var(--theme-color,#42b983);}pre>button:first-of-type{border-bottom-left-radius:4px;}"
    ), 
