  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      var calcScrollPercent = function (btn) {
        if (btn) {
          var docHeight =
            document.querySelector(".markdown-section").offsetHeight +
            THRESHOLD;
